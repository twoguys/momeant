...
Feature "A user searches stories" do
  ...
  Scenario "A user searches for a story" do
    ...
    Given "A story with the word 'jinx' in the synopsis" do
      @jinx_story = Factory :story, :synopsis => 'my cat is named jinx'
    end
    ...
    Then "I should see a link to the story with 'jinx' in the synopsis" do
